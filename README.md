...
![VirtualBox](https://img.shields.io/badge/VirtualBox-Virtual%20Lab-183A61)
...
The lab addressing is documented in the baseline evidence.

| System        | IP Address       |Role       |
| ------------- | ---------------- |---------------- |
|  Kali Linux | 192.168.100.50 |Analysis/ Scanning| 
|  Windows 11 | 192.168.100.5 |Target |
...
📁 **Baseline evidence:**
[`baseline-and-topology/`](baseline-and-topology/)
...
│   ├── 01-virtualbox-network-configuration-for-kali-and-windows-11.png
│   ├── 02-kali-network-configuration-and-connectivity.png
│   ├── 03-windows-11-network-configuration-and-connectivity.png
│   ├── 04-listening-port-windows-11.png
│   └── 05-manu-lab-topology.png
│
├── experiments/
│   ├── 01-basic-host-discovery/
│   ├── 02-port-scanning/
